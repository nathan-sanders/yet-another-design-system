...
export const InContext: Story = {
  ...
  render: () => (
    <div className="flex max-w-md flex-col gap-8">
      <div className="flex flex-col gap-4 rounded-lg border border-surface-border bg-surface-card-primary p-4 shadow-low">
      ...
      <div className="flex items-center gap-6 rounded-lg border border-surface-border bg-surface-card-primary p-4 shadow-low">
