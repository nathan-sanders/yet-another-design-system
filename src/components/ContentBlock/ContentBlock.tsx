...
const contentBlock = tv({
  ...
  variants: {
    ...
    emphasis: {
       ...
       * Surface/Background Emphasized on Surface/Border Emphasized, with Content/Inverse on top —
       ...
       *
       * It borrowed the Action/Primary pair until Surface/Background Emphasized landed
