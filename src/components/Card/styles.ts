...
export const card = tv({
  ...
  variants: {
     ...
     * bound to `Surface/Background Subtle` — its own fill — and only `default` and
     ...
     */
    emphasis: {
      /** Figma's Default: Surface/Background Primary on Surface/Border. */
      default: 'bg-surface-background-primary border-surface-border text-content-primary',
      /** Surface/Background Subtle, edge and face both. A well, not an outline. */
      subtle: 'bg-surface-background-subtle border-surface-background-subtle text-content-primary',
      /**
       * The loud one. Surface/Background Emphasized on Surface/Border Emphasized with
       ...
       */
      accent: [
        'bg-surface-background-emphasized border-surface-border-emphasized',
...
export const clickableCard = tv({
  ...
  variants: {
     ...
     *
     * Both hover to Surface/Background Subtle, **fill and border together** — read
     * back from the hover variants, where the stroke is bound to the same
     * `Surface/Background Subtle` as the fill.
     */
    emphasis: {
      /** A card that happens to be clickable. Surface/Background Primary on Surface/Border. */
      default: [
        'bg-surface-background-primary border-surface-border',
        'hover:bg-surface-background-subtle hover:border-surface-background-subtle',
      ],
      /**
       * The list row. Figma binds the stroke to `Surface/Background Primary` — the
       ...
       */
      ghost: [
        'bg-surface-background-primary border-surface-background-primary',
        'hover:bg-surface-background-subtle hover:border-surface-background-subtle',
      ],
    },
    ...
    selected: {
      true: [
        'bg-surface-background-subtle border-surface-border-emphasized',
