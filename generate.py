...
out.append("@keyframes slide-in-from-bottom {")
out.append("  from { translate: 0 100%; }")
out.append("  to   { translate: 0 0; }")
out.append("}")
out.append("")
out.append("@keyframes slide-out-to-bottom {")
out.append("  from { translate: 0 0; }")
out.append("  to   { translate: 0 100%; }")
out.append("}")
out.append("")
out.append("@theme {")
out.append("  --animate-slide-in-from-bottom: slide-in-from-bottom "
