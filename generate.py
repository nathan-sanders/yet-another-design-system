...
out.append("}")
out.append("")
out.append("/*     `progress-indeterminate` is the third, and the first that loops. A     */")
...
out.append("}")
out.append("")
out.append("/*     `skeleton-pulse` is the fourth, and the second that loops. A placeholder */")
...
out.append("}")
out.append("")
out.append("/*     `text-shimmer` is the fifth, and the third that loops. A band of a     */")
