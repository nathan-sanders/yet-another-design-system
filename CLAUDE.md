...
11. **Card** — native container using `bg-surface-card-primary`, `border-surface-border`, elevation.
12. **List Item** — variants/states; native, styled.
13. **Table Cell** — native, styled.
14. Then: Indicator, Chart Legend Buttons, Carousel Pagination Button.
