...
| **ThoughtProcess** | An assistant's reasoning folded under a quiet row — "Thinking 4s" with the app's mark while it runs, "Thought summary" once it is done — opening onto a Card of tool calls. Built on Base UI's Collapsible |
